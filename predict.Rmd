...
model <- readRDS("lgbm_wflw.rds")
model$fit$fit$fit <- readRDS.lgb.Booster("lgbm_booster.rds")
...
auth_as('/Users/demetripananos/Library/Preferences/org.R-project.R/R/rtweet/GyMBRo.rds')

post_tweet(status = '', media = c('predicted.png'), media_alt_text = c('')) 
```
